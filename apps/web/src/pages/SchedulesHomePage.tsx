// apps/web/src/pages/SchedulesHomePage.tsx
...
export default function SchedulesHomePage() {
  ...
  return (
    <GlassPage
      title="Schedules"
      subtitle="Automate runs on intervals."
      right={
        <Group>
    ...
    >
      {!wid ? (
        <EmptyState
          ...
          description="Choose a workspace to view schedules."
          primaryLabel="Go to Workspaces"
          primaryTo="/workspaces"
        />
      ) : (
        <EmptyState
          title="Open workspace schedules"
          description="Schedules are workspace-scoped."
          primaryLabel="Open Schedules"
          primaryTo={`/workspaces/${wid}/schedules`}
